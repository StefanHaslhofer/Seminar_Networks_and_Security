...
%
\def\institute{LIT Secure and Correct\newline Systems Lab,\newline Secure Systems Group}
%
%
...
%
\def\supervisor{Univ.-Prof. DI DI Dr.\newline Stefan Rass}
\newif\ifsupvismale
\supvismaletrue
%\supvismalefalse
%
...
\ifeng
 \put(11.5,-2.5){\includegraphics[width=5.2cm]{setup/cover/jku_de.pdf}} %TODO Change to english image "University"
\else
...
\ifeng
 {\large\ifcase\type Doctoral \or Diploma \or Master's \or Bachelor's \fi Thesis}%
 \vskip 2mm%
